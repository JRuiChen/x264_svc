...
struct x264_t
{
    ...
    /* MB table and cache for current frame/mb - BY MING*/
    typedef struct MBTABLE
    {
        int     i_mb_width;
        int     i_mb_height;
...
/*define two mbs,one is the working mb,the other is for Base layer - BY MING*/
     MB mb,mbBL;
		...
		/* MB table and cache for enhance Layer - BY MING*/
	typedef	struct MBEnhanceLayer
		{
			int 	i_mb_width;
			int 	i_mb_height;
			int 	i_mb_count; 				/* number of mbs in a frame */
            ...
            /*extension mb table for enhance layer - BY MING*/
	        ...
	        /* extension variable in enhance layer's mb - BY MING   */
            
			int b_spatial_resolution_flag;
			int b_base_mode_flag;
			int b_intra_pred_flag;
...
/*define two enhance layer,named mbEL1,mbEL2 respectively - BY MING*/
   mbEL mbEL1,mbEL2;
...
typedef struct x264_thread_up_sampling_arg_t
{
  //  x264_threadpool_t *pThreadpool;
    int exit;
    x264_t *pH;
} x264_thread_up_sampling_arg_t;

//struct x264_thread_up_sampling_arg_t up_sampling_arg;

extern int b_thread_up_sampling_created;
extern int i_slice_encode_threads_finished;
extern int i_slice_encode_sleeped_threads;
extern x264_thread_up_sampling_arg_t up_sampling_arg;

extern x264_pthread_mutex_t mutex_slice_encode_sleeped_threads;

extern x264_pthread_mutex_t mutex_slice_encode_threads_finished;
extern x264_pthread_cond_t cv_start_up_sampling;

extern x264_pthread_mutex_t mutex_slice_encode_thread_wakeup;
extern x264_pthread_cond_t cv_slice_encode_thread_wakeup;

extern x264_pthread_t *thread_handle_up_sampling;
