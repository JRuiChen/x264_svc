                          ...
                          void (*init_func)(void *), void *init_arg )
{
    ...
    *p_pool = pool;
    ...
    if( !b_thread_up_sampling_created )
	    CHECKED_MALLOC( pool->thread_handle_up_sampling, sizeof(x264_pthread_t) );
	    */
    ...
    /* Add by chenjie */
	/*
    if( !b_thread_up_sampling_created && x264_pthread_create( pool->thread_handle_up_sampling, NULL, (void*)x264_threadpool_up_sampling, NULL ) )
		goto fail;
