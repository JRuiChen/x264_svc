...
/* Add by chenjie */
int b_thread_up_sampling_created = 0;
int i_slice_encode_threads_finished = 0;
int i_slice_encode_sleeped_threads = 0;
x264_thread_up_sampling_arg_t up_sampling_arg;
x264_pthread_mutex_t mutex_slice_encode_threads_finished = X264_PTHREAD_MUTEX_INITIALIZER;
x264_pthread_cond_t cv_start_up_sampling;
x264_pthread_mutex_t mutex_slice_encode_thread_wakeup = X264_PTHREAD_MUTEX_INITIALIZER;
x264_pthread_cond_t cv_slice_encode_thread_wakeup;
x264_pthread_t *thread_handle_up_sampling;
